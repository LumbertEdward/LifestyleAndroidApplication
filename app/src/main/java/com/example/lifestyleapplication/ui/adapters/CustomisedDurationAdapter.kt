...
open class CustomisedDurationAdapter(val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        myViewHolder.rel.setOnClickListener {
            general.getCustomPlanDetails(list[position], mealPlan!!)
        }
    }
