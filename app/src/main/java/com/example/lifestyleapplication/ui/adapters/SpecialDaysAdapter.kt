...
open class SpecialDaysAdapter(val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        myViewHolder.rel.setOnClickListener {
            general.goToSpecialDayMealsPlan(list[position].day!!, mealPLan!!, brek!!, lunc!!, dinn!!, dest!!, condition!!);
        }
    }
    ...
    fun getDays(lst: ArrayList<day>, plan: String, brk: String, lnc: String, din: String, dst: String, cond: String){
        mealPLan = plan
        brek = brk
        lunc = lnc
        dinn = din
