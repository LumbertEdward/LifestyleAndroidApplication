...
import com.example.lifestyleapplication.databinding.FragmentIntermittentMealBinding
import com.example.lifestyleapplication.ui.constants.constants
import com.example.lifestyleapplication.ui.interfaces.IntermittentMealInterface
...
import com.example.lifestyleapplication.ui.retrofit.IntermittentMealRetrofit
...
class FragmentIntermittentMeal : Fragment() {
    private lateinit var binding: FragmentIntermittentMealBinding
    private lateinit var viewMealInterface: IntermittentMealInterface
    ...
    override fun onCreateView(
        ...
        binding = FragmentIntermittentMealBinding.inflate(inflater, container, false)
