...
open class IntermittentDurationAdapter(val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        myViewHolder.rel.setOnClickListener {
            general.getIntermittentPlanDetails(list[position], mealPlan!!)
        }
    }
